...
// Date of the day
$pdf->Cell(35, 5, 'Date:');
$pdf->TextField('date', 30, 5, array(), array('v'=>date('Y-m-d', strtotime('2018-02-17')), 'dv'=>date('Y-m-d', strtotime('2018-02-17'))));
$pdf->Ln(10);
...
$pdf->Output(__DIR__ . '/test_output/example_014.pdf', 'F');
